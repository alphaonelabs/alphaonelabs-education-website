# Generated by Django 5.1.6 on 2025-03-20 15:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "quiz",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="questions", to="web.adminquiz"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "question",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="options", to="web.adminquizquestion"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("quiz", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="web.adminquiz")),
        ...
        migrations.CreateModel(
            name="AdminQuizAnswerSubmission",
            fields=[
                ("id", models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name="ID")),
                (
                    "selected_option",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="web.adminquizoption"),
                ),
                (
                    "question",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="web.adminquizquestion"),
                ),
                (
                    "submission",
                    models.ForeignKey(
