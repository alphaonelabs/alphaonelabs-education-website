# Generated by Django 5.1.6 on 2025-03-25 20:11
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.CharField(
                choices=[("traditional", "Traditional Badge"), ("nft", "NFT Badge")], default="regular", max_length=20
            ),
        ),
        migrations.AddField(
            model_name="achievement",
        ...
        migrations.AddField(
            model_name="waitingroom",
            name="participants",
            field=models.ManyToManyField(blank=True, related_name="joined_waiting_rooms", to=settings.AUTH_USER_MODEL),
        ),
        migrations.AlterUniqueTogether(
            name="peerchallengeinvitation",
