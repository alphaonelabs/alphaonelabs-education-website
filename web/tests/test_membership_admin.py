...
from web.admin import (
    MembershipPlanAdmin,
    UserMembershipAdmin,
    MembershipSubscriptionEventAdmin
)
...
class MembershipSubscriptionEventAdminTests(TestCase):
    def setUp(self):
        ...
        event_types = [
            ...
            "payment_succeeded", "payment_failed", "past_due"
        ]
    ...
    def test_search_fields(self):
        ...
        self.assertIn('user__username', self.admin.search_fields)
        self.assertIn('user__email', self.admin.search_fields)
        self.assertIn('stripe_event_id', self.admin.search_fields)
    ...
    def test_fieldsets(self):
        ...
        # Check event information fieldset
        self.assertIn('event_type', fieldsets[0][1]['fields'])
        self.assertIn('user', fieldsets[0][1]['fields'])
        self.assertIn('membership', fieldsets[0][1]['fields'])
        self.assertIn('created_at', fieldsets[0][1]['fields'])
        
        # Check stripe information fieldset
        self.assertIn('stripe_event_id', fieldsets[1][1]['fields']) 