...
from web.models import MembershipPlan, UserMembership
...
class MembershipHelpersTests(TestCase):
    ...
    def test_get_stripe_customer_create_new(self, mock_retrieve, mock_create):
        ...
        mock_retrieve.side_effect = stripe.error.InvalidRequestError("No such customer: 'cus_test123'", param="id")
    ...
    def test_create_subscription_success(self, mock_sub_create, mock_cust_modify, mock_pm_attach, mock_get_customer):
        ...
        result = create_subscription(
            user=self.user, plan_id=self.plan.id, payment_method_id="pm_test123", billing_period="monthly"
        )
    ...
    def test_update_membership_from_subscription(self):
        ...
        self.assertAlmostEqual(
            end_date_timestamp, expected_timestamp, delta=10
