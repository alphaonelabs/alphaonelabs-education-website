...
STRIPE_MEMBERSHIP_WEBHOOK_SECRET = env("STRIPE_MEMBERSHIP_WEBHOOK_SECRET", default=STRIPE_WEBHOOK_SECRET)

# Stripe price IDs for membership plans
STRIPE_BASIC_MONTHLY_PRICE_ID = env("STRIPE_BASIC_MONTHLY_PRICE_ID", default="price_1OaXkRLkswLmMQQZlkVYMVqM")
STRIPE_BASIC_YEARLY_PRICE_ID = env("STRIPE_BASIC_YEARLY_PRICE_ID", default="price_1OaXkRLkswLmMQQZ1sWBB0TJ")
STRIPE_PRO_MONTHLY_PRICE_ID = env("STRIPE_PRO_MONTHLY_PRICE_ID", default="price_1OaXlDLkswLmMQQZVqS8KJPM")
STRIPE_PRO_YEARLY_PRICE_ID = env("STRIPE_PRO_YEARLY_PRICE_ID", default="price_1OaXlDLkswLmMQQZJdjMCQz7")
STRIPE_PREMIUM_MONTHLY_PRICE_ID = env("STRIPE_PREMIUM_MONTHLY_PRICE_ID", default="price_1OaXmSLkswLmMQQZhC5ftxe0")
STRIPE_PREMIUM_YEARLY_PRICE_ID = env("STRIPE_PREMIUM_YEARLY_PRICE_ID", default="price_1OaXmSLkswLmMQQZXcSPXVfq")
