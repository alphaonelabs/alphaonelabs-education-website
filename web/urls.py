...
urlpatterns += i18n_patterns(
    ...
    path("courses/<slug:course_slug>/session-waiting-room/join/", views.join_session_waiting_room, name="join_session_waiting_room"),
    path("courses/<slug:course_slug>/session-waiting-room/leave/", views.leave_session_waiting_room, name="leave_session_waiting_room"),
