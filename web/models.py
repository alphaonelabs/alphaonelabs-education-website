...
class Order(models.Model):
    ...
    goods = models.ManyToManyField(Goods, through="OrderItem")  # Many items per order
...
class OrderItem(models.Model):
    """Intermediate model for storing order details"""
    ...
    def __str__(self):
        return f"{self.quantity} x {self.goods.name} in Order {self.order.id}"
