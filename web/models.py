...
class Chapter(models.Model):
    ...
    slug = models.SlugField(unique=True, max_length=200)
    description = models.TextField()
    region = models.CharField(max_length=200, help_text="City, state, country, or geographic area")
    logo = models.ImageField(upload_to="chapter_logos", blank=True)
...
class ChapterApplication(models.Model):
    ...
    def __str__(self):
        return f"{self.chapter_name} - {self.applicant.username} ({self.get_status_display()})"
