...
from .models import MembershipPlan, UserMembership, MembershipSubscriptionEvent
...
class MembershipPlanAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ('Plan Information', {
            'fields': ('name', 'description', 'is_active', 'is_popular', 'order')
        }),
        ('Pricing', {
            'fields': (
                'billing_period', 
...
class MembershipSubscriptionEventAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ('Event Information', {
            'fields': ('event_type', 'user', 'membership', 'created_at')
        }),
        ('Stripe Information', {
